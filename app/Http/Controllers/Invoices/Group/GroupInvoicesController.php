...
namespace App\Http\Controllers\Invoices\Group;
...
{
    protected $group;
    public function __construct(Group_Invoices_Interface $group)
    {
      $this->group=$group;
    }
    /**
    ...
    {
        return $this->group->update($id,$request);
    }
