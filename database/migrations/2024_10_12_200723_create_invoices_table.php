...
class CreateInvoicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoices', function (Blueprint $table) {
            ...
            $table->foreignId('group_id')->nullable()->constrained('multi_services')->onDelete('cascade')->onUpdate('cascade');
            $table->foreignId('service_id')->nullable()->constrained('single_services')->onDelete('cascade')->onUpdate('cascade');
