...
<div class="page-wrapper {{ LaravelLocalization::getCurrentLocale() ==='ar' ? 'rtl': ''}}">
    ...
    <header class="main-header header-style-three">
            ...
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="index.html" class="img-responsive">
                        <img src="Website/images/logo-6.png" alt="Hospital Logo" title="Hospital" class="logo-image">
                    </a>
                </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="{{asset('Website/images/nav-logo.png')}}" alt="" title=""></a></div>
