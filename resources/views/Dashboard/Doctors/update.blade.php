...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('doctor.update',['id'=>$doctor->id])}}" method="POST" autocomplete="off"
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            <div>
                                ...
                                @else
                                    <img style="border-radius:50%"
                                         src="{{Url::asset('Dashboard/img/doctors/Doctors_For_Men.avif')}}"
                                         height="50px"
                                         width="50px" alt="">
                                @endif
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" value="{{$doctor->phone_number}}" name="phone_number"
                                           type="tel">
                                    ...
                                    <select multiple="multiple" class="testselect2" name="appointments[]">
                                        ...
                                        @foreach($appointments as $appointment)
                                            <option value="{{$appointment->id}}"
                                                    @if(in_array($appointment->id, $doctorAppointments)) selected @endif>
                                                {{$appointment->name}}
                                            </option>
                                        @endforeach
                                    </select>
