			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class=""{{$doctor=auth('doctor')->user()}}>
							@if($doctor->image)
                                <img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('Dashboard/img/doctors/'.$doctor->image->filename)}}"><span class="avatar-status profile-status bg-green"></span>
                            @else
                                <img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('Dashboard/img/6.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('doctor-invoices.index') }}">كل الكشوفات </a></li>
                            <li><a class="slide-item" href="{{route('complete.statements')}}">قائمة الكشوفات المكتملة</a></li>
                            <li><a class="slide-item" href="{{route('reviews')}}">قائمة المراجعات</a></li>
