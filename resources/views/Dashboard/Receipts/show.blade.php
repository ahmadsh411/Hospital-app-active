...
@section('css')
    ...
    <style>
        ...
        /* إجبار النصوص على الظهور في سطر واحد */
        .receipt-info {
            ...
            <div class="receipt-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <span class="receipt-info" id="beneficiary-name">{{ $receipt->patient->name }}</span>
                    </div>
                    <div class="col-md-6 text-right">
                        <label for="receipt-date">التاريخ:</label>
                        <span class="receipt-info" id="receipt-date">{{ $receipt->date }}</span>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-md-8">
                        ...
                        <span class="receipt-info" id="description">{{ $receipt->description }}</span>
                    </div>
                    <div class="col-md-4 text-right">
                        <label for="amount">المبلغ:</label>
                        <span class="receipt-info" id="amount">{{ $receipt->debit }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="receipt-footer mt-5">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <span class="receipt-info" id="employee-name">{{ $receipt->employee->name ?? '' }}</span>
                    </div>
                    <div class="col-md-6 text-right">
