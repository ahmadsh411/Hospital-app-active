                                ...
                                <div class="card-sigin">
                                    ...
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            ...
                                            {{-- <div id="user" class="loginform">
                                                <h5 class="mb-4 font-weight-semibold">{{trans("Dashboard/login_trans.user")}}</h5>

                                                <form method="POST" action="{{ route('login.user') }}" autocomplete="off">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label>{{ trans('Dashboard/login_trans.email') }}</label>
                                                        <input class="form-control" placeholder="Enter Your Email Address" name="email" type="text">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="row row-xs">
                                                        ...
                                                        <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                                            <button class="btn btn-info btn-block"><i class="fab fa-twitter"></i> {{ trans('Dashboard/login_trans.Signup with Twitter') }}</button>
                                                        </div>
                                                    </div>
                                                </form>
                                                <div class="mt-5 main-signin-footer">
                                                    <p><a href="">{{ trans('Dashboard/login_trans.Forgot password?') }}</a></p>
                                                    <p>{{ trans("Dashboard/login_trans.Don't have an account?") }} <a href="{{ url('/' . $page='signup') }}">{{ trans('Dashboard/login_trans.Create an Account') }}</a></p>
                                                </div>
                                            </div> --}}
                                            {{--Admin Login Form--}}
                                            <div id="admin" class="loginform">
                                                <h5 class="mb-4 font-weight-semibold">Login Staff</h5>
            ...
            <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
                <div class="mx-auto text-center row wd-100p">
                    <div class="mx-auto my-auto col-md-12 col-lg-12 col-xl-12 wd-100p">
                        <img src="{{URL::asset('Dashboard/img/4193.jpg')}}" class="mx-auto my-auto ht-xl-80p wd-md-100p wd-xl-80p" alt="logo">
                    </div>
                </div>
            </div><!-- End -->
        </div>
