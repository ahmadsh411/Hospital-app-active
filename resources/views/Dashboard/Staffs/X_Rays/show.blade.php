...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('messages.invoices_and_rays') }}</h4>
...
@section('content')
    <div class="container">
        <h2>{{ __('messages.ray_tests_for_staff') }}: {{ $staff->name }}</h2>
                ...
                <table class="table table-bordered">
                    ...
                    @foreach($rays as $ray)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('staff.x-ray-information', $ray->id) }}" class="btn btn-info">{{ __('messages.view_details') }}</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
        ...
        @else
            <div class="alert alert-warning">
                <p>{{ __('messages.no_rays_for_staff') }}</p>
            </div>
        @endif
    </div>
@endsection
