...
@section('content')
    ...
    <div>
        ...
        <form action="{{route('single-invoices.update',['single_invoice'=>$singleInvoice->id])}}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row mt-4">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" id="patient_id" name="patient_id" required>
                        @foreach($patients as $patient)
                            <option value="{{ $patient->id }}" {{ $patient->id == $singleInvoice->patient->id ? 'selected' : '' }}>{{ $patient->name }}</option>
                        @endforeach
                    </select>
                </div>
                    ...
                    <select class="form-control" id="service_id" name="service_id" required>
                        ...
                        @foreach($services as $service)
                            <option value="{{ $service->id }}"
                                    data-price="{{ $service->price }}" {{ $service->id == $singleInvoice->service->id ? 'selected' : '' }}>
                                {{ $service->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" step="0.01" class="form-control" id="price" name="price"
                           value="{{ $singleInvoice->price }}" readonly>
                </div>
