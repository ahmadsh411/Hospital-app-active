                        ...
                        <table id="example" class="table table-striped table-bordered text-md-nowrap">
                            ...
                            @foreach($singleInvoices as $singleInvoice)
                                <tr>
                                    ...
                                    <td>{{ $singleInvoice->service->name }}</td>
                                    ...
                                    <td>
                                        ...
                                        <script>
                                            function func1() {
                                                window.location.href = "{{route('single-invoices.edit', ['single_invoice' => $singleInvoice->id])}}";
                                            }
                                        </script>
                                        ...
                                        <script>
                                            function show() {
                                                window.location.href = "{{route('single-invoices.show',['single_invoice'=>$singleInvoice->id])}}"
                                            }
                                        </script>
                                    </td>
                                </tr>
