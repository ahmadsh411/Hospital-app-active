<div>
    ...
    @else
    <button type="button" wire:click="show_table_function" class="btn btn-outline-primary">اظهار العروض </button>
    <br>
    <br>
    <form wire:submit.prevent="saveGroup" autocomplete="off" class="form-group">
        @csrf
        ...
        <div class="card mt-4">
            <div class="card-header">
                <div class="col-md-12">
                    <button class="btn btn-outline-primary" wire:click.prevent="addService">اضافة خدمة فرعية</button>
                </div>
            </div>
                            ...
                            <tr>
                                        ...
                                        <select name="GroupsItems[{{$index}}][service_id]"
                                            ...
                                            @foreach ($allServices as $service)
                                                <option value="{{ $service->id }}">
                                                    {{ \App\Models\Service\SingleServiceTranslation::where('single_service_id', $service->id)->pluck('name')->first() }}
                                ...
                                <td>
                                    ...
                                    @elseif($groupItem['service_id'])
                                        <button class="btn btn-sm btn-success mr-1" wire:click.prevent="saveService({{$index}})">تأكيد</button>
                                    @endif
