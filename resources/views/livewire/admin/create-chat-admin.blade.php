<div>
    ...
    <div class="container mt-5">
        <h3 class="mb-4 text-center">{{ __('messages.Create New Conversation') }}</h3>
            ...
            <ul class="list-group list-group-flush">
                @foreach($doctors as $doctor)
                    <li class="list-group-item doctor-item">
                        <!-- زر شفاف -->
                        <button wire:click="createConversationAdmin('{{ $doctor->email }}')" class="invisible-button"></button>
            ...
            <ul class="list-group list-group-flush">
                @foreach($staffs as $staff)
                    <li class="list-group-item admin-item">
                        <!-- زر شفاف -->
                        <button wire:click="createConversationAdmin('{{ $staff->email }}')" class="invisible-button"></button>
