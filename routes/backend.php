...
use App\Http\Controllers\Conversations\AdminConversationController;
...
Route::group(
    ...
    function () { //...
        ...
        Route::group([
            ...
            //    ########################proifle Admin#########################################################
            Route::get('show-admin-profile', [\App\Http\Controllers\Auth\Profile\ProfileController::class, 'show'])->name('profile.show');
            Route::get('edit-admin-profile', [\App\Http\Controllers\Auth\Profile\ProfileController::class, 'edit'])->name('profile.edit');
            Route::post('update-admin-profile', [\App\Http\Controllers\Auth\Profile\ProfileController::class, 'update'])->name('profile.update');
            // ###################################Conversation#######################################################
            Route::get('create-conversation',\App\Http\Livewire\Admin\CreateChatAdmin::class)->name('create.conversation');
            Route::get('admin-chat',\App\Http\Livewire\Admin\MainAdmin::class)->name('admin.chat');
